            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="border-b-2 border-primary/20">
                                <th className="text-left p-6 text-primary font-semibold text-lg w-1/3">{t("specifications.table.tableHead.coreInnovation")}</th>
                                <th className="text-left p-6 text-primary font-semibold text-lg w-1/3">{t("specifications.table.tableHead.howItWorks")}</th>
                                <th className="text-left p-6 text-primary font-semibold text-lg w-1/3">{t("specifications.table.tableHead.whyItMatters")}</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div className="lg:hidden">
                    ...
                    <div className="flex justify-center mt-4">
                        <p className="text-slate-400 text-sm">{t("specifications.table.swipeToExplore")}</p>
                    </div>
                </div>
            </div>
        </section>
